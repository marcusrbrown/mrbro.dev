  ...
  repositories: [
    {
      ...
      full_name: 'marcusrbrown/awesome-react-app',
      ...
      topics: ['react', 'typescript', 'vite', 'pwa', 'portfolio'],
    },
    {
      id: 2,
      name: 'api-server-node',
      full_name: 'marcusrbrown/api-server-node',
      ...
      homepage: null,
      topics: ['nodejs', 'express', 'mongodb', 'api', 'portfolio'],
    },
    {
      id: 3,
      name: 'python-data-analysis',
      full_name: 'marcusrbrown/python-data-analysis',
      ...
      topics: ['python', 'data-science', 'pandas', 'visualization', 'portfolio'],
    },
    {
      id: 4,
      name: 'mobile-flutter-app',
      full_name: 'marcusrbrown/mobile-flutter-app',
      ...
      homepage: null,
      topics: ['flutter', 'dart', 'mobile', 'cross-platform', 'portfolio'],
    },
    {
      id: 5,
      name: 'rust-cli-tool',
      full_name: 'marcusrbrown/rust-cli-tool',
      ...
      topics: ['rust', 'cli', 'system-administration', 'performance', 'portfolio'],
    },
    {
      id: 6,
      name: 'vue-dashboard',
      full_name: 'marcusrbrown/vue-dashboard',
      ...
      topics: ['vue', 'dashboard', 'charts', 'analytics', 'portfolio'],
    },
  ],
  issues: [
    {
